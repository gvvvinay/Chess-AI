...
export default function Game() {
    ...
    return (
        <div className="flex flex-col items-center gap-4">
            <div className="w-[350px] md:w-[500px] h-[350px] md:h-[500px]">
                <Chessboard position={game.fen()} onPieceDrop={onDrop} />
            </div>

            {status && (
                <div className="px-4 py-2 bg-red-600 rounded-lg animate-pulse font-bold">
                    {status}
                </div>
            )}

            {isThinking && !status && (
                <div className="text-violet-400 font-mono text-sm animate-pulse">
